    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Start your audiobook journey today</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create an account to access thousands of audiobooks
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="updates" className="text-sm">
                    Send me email updates about new releases and recommendations
                  </Label>
                </div>
              </div>
